...
高飞，西安电子科技大学杭州研究院，副研究员、湘湖菁英教授，入选**浙江省万人计划青年科技人才**。2015年获西安电子科技大学博士学位，曾于澳大利亚悉尼科技大学进行博士联合培养。长期从事计算机视觉研究，在 **IEEE TNNLS**、**TIP**、**CVPR**、**ICCV**、**ACM MM**、**ICRA** 等期刊/会议发表论文50余篇。主持国家自然科学基金面上/青年项目等纵向课题，获陕西省科学技术奖一等奖、IEEE ICME'21最佳展示奖亚军、全国博士后创新创业大赛铜奖等。
...
- **`CPSP`** Qian Xu, Xi Li, Fei Gao, Qiming Zhang, Mingjin Zhang. *CPSP: Channel Polarization and Global-Budget Structured Pruning for Infrared Small Target Detection.* **ACM MM**, 2026.

- **`RidgeField-Net`** Mingjin Zhang, Shuaipeng Fan, Fei Gao, Jie Guo, Yunsong Li. *RidgeField-Net: Continuous Spatio-Temporal Tube Fields for Tiny UAV Detection in Event Streams.* **ACM MM**, 2026.
...
- **`PSMix`** Xin Wei, Qin Yang, Hongji Zhao, Fei Gao, Mingrui Zhu, Nannan Wang, Xinbo Gao. *PSMix: Robust Point Cloud Recognition through Spectral Domain Mixing.* **ICML**, 2026. [![Paper](https://img.shields.io/badge/Paper-ICML-00629b?style=flat-square)](https://icml.cc/virtual/2026/poster/60723)
...
- **`CADQ`** Yongjie Hu, Yifan Jiang, Ziyun Li, Fei Gao\*, Henrik Boström, Nannan Wang. *CADQ: Attribute-Consistent Face Cartoonization with Cross-modal Aligned and Deformable Quantization.* **ACM MM**, 10681-10689, Oct. 2025. [![Paper](https://img.shields.io/badge/Paper-ACM-0085CA?style=flat-square&logo=acm&logoColor=white)]() [![Code](https://img.shields.io/badge/Code-GitHub-2b6cb0?style=flat-square&logo=github&logoColor=white)](https://github.com/IIP-Lab-XDU/CADQ)

- **`Q-Norm`** Lanning Zhang, Ying Zhou, Fei Gao\*, Ziyun Li, Maoying Qiao, Jinlan Xu, Nannan Wang\*. *Q-Norm: Robust Representation Learning via Quality-Adaptive Normalization.* **ICCV**, 13901-13911, Oct. 2025. [![Paper](https://img.shields.io/badge/Paper-ICCV-00629b?style=flat-square)]()

- **`SAIST`** Mingjin Zhang, Xiaolong Li, Fei Gao, Jie Guo, Xinbo Gao, Jing Zhang. *SAIST: Segment Any Infrared Small Target Model Guided by Contrastive Language-Image Pre-training.* **CVPR**, 9549-9558, 2025.

- **`QuARF`** Fei Gao, Ying Zhou, Ziyun Li, Wenwang Han, Jiaqi Shi, Maoying Qiao, Jinlan Xu, Nannan Wang\*. *QuARF: Quality-Adaptive Receptive Fields for Degraded Image Perception.* **AAAI**, 39(16): 16708-16716, 2025. [![Paper](https://img.shields.io/badge/Paper-AAAI-005A9C?style=flat-square)](https://ojs.aaai.org/index.php/AAAI/article/view/32849) [![Code](https://img.shields.io/badge/Code-GitHub-2b6cb0?style=flat-square&logo=github&logoColor=white)](https://github.com/AiArt-Gao/QuARF)

- **`S3D`** Mingjin Zhang, Wenteng Shang, Fei Gao\*, Qiming Zhang, FengQin Lu, Jing Zhang. *Semi-supervised Infrared Small Target Detection with Thermodynamic-Inspired Uneven Perturbation and Confidence Adaptation.* **AAAI**, 39(10): 10013-10021, 2025.

- **`MOCID`** Mingjin Zhang, Yuanjun Ouyang, Fei Gao, Jie Guo, Qiming Zhang\*, Jing Zhang. *MOCID: Motion Context and Displacement Information Learning for Moving Infrared Small Target Detection.* **AAAI**, 39(10): 10022-10030, 2025.

- **`IRMamba`** Mingjin Zhang, Xiaolong Li, Fei Gao, Jie Guo. *IRMamba: Pixel Difference Mamba with Layer Restoration for Infrared Small Target Detection.* **AAAI**, 39(9): 10003-10011, 2025.

### 2024

- **`AesMamba`** Fei Gao, Yuhao Lin, Jiaqi Shi, Maoying Qiao, Nannan Wang\*. *AesMamba: Universal Image Aesthetic Assessment with State Space Models.* **ACM MM (Oral)**, 7444-7453, 2024. [![Paper](https://img.shields.io/badge/Paper-ACM-0085CA?style=flat-square&logo=acm&logoColor=white)](https://dl.acm.org/doi/abs/10.1145/3664647.3681011) [![arXiv](https://img.shields.io/badge/arXiv-2408.12345-b31b1b?style=flat-square&logo=arxiv&logoColor=white)](https://openreview.net/forum?id=obaazx0Hbz) [![Code](https://img.shields.io/badge/Code-GitHub-2b6cb0?style=flat-square&logo=github&logoColor=white)](https://github.com/AiArt-Gao/AesMamba)

- **`HMEG-SG`** Yu Chen, Fei Gao\*, Yanguang Zhang, Maoying Qiao, Nannan Wang\*. *Generating Handwritten Mathematical Expressions From Symbol Graphs: An End-to-End Pipeline.* **CVPR**, 15675-15685, June 2024. [![Paper](https://img.shields.io/badge/Paper-CVPR-00629b?style=flat-square)](https://cvpr.thecvf.com/virtual/2024/poster/31503) [![Code](https://img.shields.io/badge/Code-GitHub-2b6cb0?style=flat-square&logo=github&logoColor=white)](https://github.com/AiArt-Gao/HMEG)
...
- **`MATEIT`** Chang Jiang, Fei Gao\*, Biao Ma, Yuhao Lin, Nannan Wang, Gang Xu. *Masked and Adaptive Transformer for Exemplar Based Image Translation.* **CVPR**, 22418-22427, 2023. [![arXiv](https://img.shields.io/badge/arXiv-2303.17123-b31b1b?style=flat-square&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2303.17123) [![Code](https://img.shields.io/badge/Code-GitHub-2b6cb0?style=flat-square&logo=github&logoColor=white)](https://github.com/AiArt-Gao/MATEBIT)

- **`CHAN`** Fei Gao, Xingxin Xu, Jun Yu, Meimei Shang, Xiang Li, Dacheng Tao. *Complementary, Heterogeneous and Adversarial Networks for Image-to-Image Translation.* **IEEE TIP**, 30: 3487-3498, 2021. [![Paper](https://img.shields.io/badge/Paper-IEEE-00629b?style=flat-square&logo=ieee&logoColor=white)](https://ieeexplore.ieee.org/document/9366371) [![Project](https://img.shields.io/badge/Project-Page-9B59B6?style=flat-square)](https://fei-hdu.github.io/chan/)

- **`CA-GAN`** Jun Yu, Xingxin Xu, Fei Gao\*, Shengjie Shi, et al. *Towards Realistic Face Photo-Sketch Synthesis via Composition-Aided GANs.* **IEEE TCYB**, 51(9): 4350-4362, 2021. [![arXiv](https://img.shields.io/badge/arXiv-1712.00899-b31b1b?style=flat-square&logo=arxiv&logoColor=white)](https://arxiv.org/abs/1712.00899) [![Project](https://img.shields.io/badge/Project-Page-9B59B6?style=flat-square)](https://fei-hdu.github.io/ca-gan/)

- **`NAS-Lung`** Hanliang Jiang, Fuhao Shen, Fei Gao\*, Weidong Han. *Learning Efficient, Explainable and Discriminative Representations for Pulmonary Nodules Classification.* **PR**, 113: 107825, 2021. [![arXiv](https://img.shields.io/badge/arXiv-2101.07429-b31b1b?style=flat-square&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2101.07429) [![Code](https://img.shields.io/badge/Code-GitHub-2b6cb0?style=flat-square&logo=github&logoColor=white)](https://github.com/fei-hdu/NAS-Lung)

- **`iSkecher`** Fei Gao, Jingjie Zhu, Zeyuan Yu, Peng Li, Tao Wang. *Making Robots Draw A Vivid Portrait In Two Minutes.* **IROS**, 9585-9591, 2020. [![arXiv](https://img.shields.io/badge/arXiv-2005.05526-b31b1b?style=flat-square&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2005.05526) [![Project](https://img.shields.io/badge/Project-Page-9B59B6?style=flat-square)](https://ricelll.github.io/AiSketcher/)

- **`ReLIC`** Lin Zhao, Meimei Shang, Fei Gao\*, et al. *Representation Learning of Image Composition for Aesthetic Prediction.* **CVIU**, 199: 103024, Oct. 2020. [![Paper](https://img.shields.io/badge/Paper-CVIU-00629b?style=flat-square)](https://www.sciencedirect.com/science/article/abs/pii/S1077314220300801) [![Code](https://img.shields.io/badge/Code-GitHub-2b6cb0?style=flat-square&logo=github&logoColor=white)](https://github.com/fei-hdu/ReLIC)

- **`BLINDER`** Fei Gao, Jun Yu, Suguo Zhu, Qingming Huang, Qi Tian. *Blind Image Quality Prediction by Exploiting Multi-level Deep Representations.* **PR**, 81:432-442, Sep. 2018. [![Paper](https://img.shields.io/badge/Paper-PR-00629b?style=flat-square)](https://www.sciencedirect.com/science/article/pii/S003132031830150X)

- **`RankIQA`** Fei Gao, Dacheng Tao, Xinbo Gao, Xuelong Li. *Learning to rank for blind image quality assessment.* **IEEE TNNLS**, 26(10): 2275-2290, Oct. 2015.

- **`NSS-MKL`** Xinbo Gao, Fei Gao, Dacheng Tao, Xuelong Li. *Universal blind image quality assessment metrics via natural scene statistics and multiple kernel learning.* **IEEE TNNLS**, 24(12): 2013-2026, 2013.
