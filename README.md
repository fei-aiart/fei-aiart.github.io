...
### 2026
- [**OOTD**] Derui Zhang, Yiji Feng, Fei Gao\*, Nannan Wang. *One is Enough: Disentangled Style Transfer via One-to-One Token Distillation.* **ACM MM**, 2026.~ [[Github]](https://github.com/IIP-Lab-XDU/OOTD)
...
### 2025
- [**S3OIL**] Xi Yang, Haoyuan Shi, Ziyun Li, Maoying Qiao, Fei Gao\*, Nannan Wang. *S3OIL: Semi-Supervised SAR-to-Optical Image Translation via Multi-Scale and Cross-Set Matching.* **IEEE TIP**, 6641-6654, Oct. 2025. [[Paper]](https://ieeexplore.ieee.org/abstract/document/11196005) ~ [Github]
- [**KAN Policy**] Zikang Chen, Fei Gao, Ziya Yu, Peng Li. *KAN Policy: Learning Efficient and Smooth Robotic Trajectories via Kolmogorov-Arnold Networks.* **IEEE RAL**, 11164-11171, Sep. 2025. [[Paper]](https://ieeexplore.ieee.org/abstract/document/11151197) ~ [Github]
- [**CADQ**] Yongjie Hu, Yifan Jiang, Ziyun Li, Fei Gao\*, Henrik Boström, Nannan Wang. *CADQ: Attribute-Consistent Face Cartoonization with Cross-modal Aligned and Deformable Quantization.* **ACM MM**, Oct. 2025. [Paper] ~ [[Github]](https://github.com/IIP-Lab-XDU/CADQ)
- [**Q-Norm**] Lanning Zhang, Ying Zhou, Fei Gao\*, Ziyun Li, Maoying Qiao, Jinlan Xu, Nannan Wang*. *Q-Norm: Robust Representation Learning via Quality-Adaptive Normalization.* **ICCV**, Oct. 2025. [Paper] ~ [[Github]](https://github.com/IIP-Lab-XDU/Q-Norm)
...
- [**QuARF**] Fei Gao, Ying Zhou, Ziyun Li, Wenwang Han, Jiaqi Shi, Maoying Qiao, Jinlan Xu, Nannan Wang*. *QuARF: Quality-Adaptive Receptive Fields for Degraded Image Perception.* **AAAI**, 39(16): 16708-16716, 2025. [Paper] ~ [[Github]](https://github.com/AiArt-Gao/QuARF)
...
- [**HMEG-SG**] Yu Chen, Fei Gao\*, Yanguang Zhang, Maoying Qiao, Nannan Wang\*. *Generating Handwritten Mathematical Expressions From Symbol Graphs: An End-to-End Pipeline.* **CVPR**, 15675-15685, June 2024. [[Paper]](https://cvpr.thecvf.com/virtual/2024/poster/31503) ~ [[Github]](https://github.com/AiArt-Gao/HMEG)
...
- [**iSkecher**] Fei Gao, Jingjie Zhu, Zeyuan Yu, Peng Li, Tao Wang. *Making Robots Draw A Vivid Portrait In Two Minutes.* **IROS**, pp. 9585-9591, 2020. [[Paper_IROS]](https://ras.papercept.net/proceedings/IROS20/1854.pdf) ~ [[Paper_arXiv]](https://arxiv.org/abs/2005.05526) ~ [[Project]](https://ricelll.github.io/AiSketcher/)
- [**ReLIC**] Lin Zhao, Meimei Shang, Fei Gao\*, et al. *Representation Learning of Image Composition for Aesthetic Prediction.* **CVIU**, vol. 199, 103024, Oct. 2020. [[Project]](https://github.com/fei-hdu/ReLIC) ~ [[Paper]](https://www.sciencedirect.com/science/article/abs/pii/S1077314220300801)
...
- [**BLINDER**] Fei Gao, Jun Yu, Suguo Zhu, Qingming Huang, Qi Tian. *Blind Image Quality Prediction by Exploiting Multi-level Deep Representations.* **PR**, vol 81, pp. 432-442, Sep. 2018. [[Paper]](https://www.sciencedirect.com/science/article/pii/S003132031830150X)
