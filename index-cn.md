...
[![English](https://img.shields.io/badge/English-2b6cb0?style=flat-square)](./en.md) [![中文](https://img.shields.io/badge/中文-2b6cb0?style=flat-square)](./)
## 📝 个人简介
...
- **`CADQ`** Yongjie Hu, Yifan Jiang, Ziyun Li, Fei Gao\*, Henrik Boström, Nannan Wang. *CADQ: Attribute-Consistent Face Cartoonization with Cross-modal Aligned and Deformable Quantization.* **ACM MM**, Oct. 2025. [![Paper](https://img.shields.io/badge/Paper-ACM-0085CA?style=flat-square&logo=acm&logoColor=white)]() [![Code](https://img.shields.io/badge/Code-GitHub-2b6cb0?style=flat-square&logo=github&logoColor=white)](https://github.com/IIP-Lab-XDU/CADQ)

- **`Q-Norm`** Lanning Zhang, Ying Zhou, Fei Gao\*, Ziyun Li, Maoying Qiao, Jinlan Xu, Nannan Wang\*. *Q-Norm: Robust Representation Learning via Quality-Adaptive Normalization.* **ICCV**, Oct. 2025. [![Paper](https://img.shields.io/badge/Paper-ICCV-00629b?style=flat-square)]()
...
- **`RankIQA`** Fei Gao, Dacheng Tao, Xinbo Gao, Xuelong Li. *Learning to rank for blind image quality assessment.* **IEEE TNNLS**, vol. 26, no. 10, pp. 2275-2290, Oct. 2015.

- **`NSS-MKL`** Xinbo Gao, Fei Gao, Dacheng Tao, Xuelong Li. *Universal blind image quality assessment metrics via natural scene statistics and multiple kernel learning.* **IEEE TNNLS**, vol. 24, no. 12, pp. 2013-2026, 2013.
